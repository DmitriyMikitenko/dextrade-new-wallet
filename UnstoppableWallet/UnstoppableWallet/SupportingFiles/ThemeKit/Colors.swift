...
extension Color {
    public static let themeGray = Color("Gray", bundle: Bundle.main)
    public static let themeLightGray = Color("LightGray", bundle: Bundle.main)
    public static let themeDark = Color("Dark", bundle: Bundle.main)
    public static let themeDarker = Color("Darker", bundle: Bundle.main)
    public static let themeSteel = Color("Steel", bundle: Bundle.main)
    public static let themeSteelLight = Color("SteelLight", bundle: Bundle.main)
    public static let themeYellow = Color("Yellow", bundle: Bundle.main)
    public static let themeGreen = Color("Green", bundle: Bundle.main)
    public static let themeRed = Color("Red", bundle: Bundle.main)
    public static let themeStronbuy = Color("Stronbuy", bundle: Bundle.main)
    ...
    public static let themeJacob = Color("Jacob", bundle: Bundle.main)
    public static let themeRemus = Color("Remus", bundle: Bundle.main)
    public static let themeLucian = Color("Lucian", bundle: Bundle.main)
    public static let themeLeah = Color("Leah", bundle: Bundle.main)
    public static let themeAndy = Color("Andy", bundle: Bundle.main)
    public static let themeBlackTenTwenty = Color("BlackTenTwenty", bundle: Bundle.main)
    public static let themeBran = Color("Bran", bundle: Bundle.main)
    public static let themeClaude = Color("Claude", bundle: Bundle.main)
    public static let themeHelsing = Color("Helsing", bundle: Bundle.main)
    public static let themeJeremy = Color("Jeremy", bundle: Bundle.main)
    public static let themeLaguna = Color("Laguna", bundle: Bundle.main)
    public static let themeLawrence = Color("Lawrence", bundle: Bundle.main)
    public static let themeLawrencePressed = Color("LawrencePressed", bundle: Bundle.main)
    public static let themeNina = Color("Nina", bundle: Bundle.main)
    public static let themeRaina = Color("Raina", bundle: Bundle.main)
    public static let themeTyler = Color("Tyler", bundle: Bundle.main)
    public static let themeTyler96 = Color("Tyler96", bundle: Bundle.main)
