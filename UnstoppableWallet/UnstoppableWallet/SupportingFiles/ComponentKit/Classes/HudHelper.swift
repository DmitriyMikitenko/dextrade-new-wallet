...
extension HudHelper {
    ...
    public func showSuccessBanner(title: String) {
        show(banner: HudBannerType.success(title: title))
    }

    public func showErrorBanner(title: String) {
        show(banner: HudBannerType.error(string: title))
    }
...
extension HudHelper {
    ...
    private func show(banner: HudBannerType) {
        var config = HUDConfig()
