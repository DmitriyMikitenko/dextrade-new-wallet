...
class TransactionInfoService {
    ...
    init(transactionRecord: TransactionRecord, adapter: ITransactionsAdapter, currencyKit: CurrencyKit, rateService: HistoricalRateService, nftMetadataService: NftMetadataService) {
